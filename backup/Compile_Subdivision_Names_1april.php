<?php
    ...
    try
    {
       ...
       $mySql->connect();
		...
		// $mySql->query('SELECT l.Location_id,l.Sub_id,l.Subdivision,l.City_id FROM Real_Location l, tb_City c WHERE l.City_id = c.City_id AND c.Include=1 AND l.dict_Sub = 0 AND NOT ISNULL(l.Subdivision) AND l.Subdivision!="" AND  l.Location_id = 80983 ORDER BY 2, 3');
