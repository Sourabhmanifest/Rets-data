					...
					{	
						...
						foreach($matchlikescoredata as $score_records)
						{
							...
							if($MoreLike_Base['PerfectScore']!=0)
							{
								...
								$mySql->query("UPDATE MoreLike_Listings SET MatchPercent = ".$MatchPercent." WHERE Property_id = ".$Property_id." AND qProp_id = ".$score_records['qProp_id']);
							}
						}
					}
				}	
